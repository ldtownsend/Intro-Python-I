...
# It should inheret from Waypoint because it has 'lat', 'lon' and 'name' as 
# parameters.
...
class Geocache(Waypoint):
    ...
    def __str__(self):
        return "Lat: {}, Lon: {}, Name: {}, Difficulty: {}, Size: {}".format(self.lat, self.lon, self.name, self.difficulty, self.size)
